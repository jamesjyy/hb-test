...
public class FileUtil {
	...
	// 项目路径从配置文件获取
	private static String rootPath=CommonConstants.getConfigInfo("rootPath");
	...
	/* 视频 */
	private static String[] avi = { "avi", "navi", "wma", "mpeg", "mpg", "mov", "wmv", "rmvb", "rm", "flash", "flv", "mp4", "mid", "3gp", "asf" };
	/* 其他 */
	private static String[] other = { "rar", "zip","xml" };
	...
	public static String getUploadBasePath() {
		...
		// String basepath = SystemStrConstant.uploadPath;
		return basepath;
	}
