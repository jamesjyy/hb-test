...
const Print = function (dom, options) {
  ...
  Print.prototype = {
    ...
    getHtml: function () {
      ...
      var pages = document.querySelectorAll('.report');
    ...
    writeIframe: function (content) {
      ...
      iframe.setAttribute('style', 'position:absolute;width:' + document.querySelector('#reportPrint').clientWidth + 'px;height:0;top:-10px;left:-10px;');
