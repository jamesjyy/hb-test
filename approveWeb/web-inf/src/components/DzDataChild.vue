  ...
  export default {
    ...
    methods: {
      ...
      detailsclick(row) {
        ...
        // var str = this.userid
        window.location.href = './DzDataAnalyse.html?' + str;
      },
      initData: function () {
        ...
        request({
          ...
          params: {
            ...
            this.tableData = res.data.data.dzDataChildList;
