...
import {AdmininitData} from '@/network/dydatainfo/dydatainfo'
import {PtuserinitData} from '@/network/dydatainfo/dydatainfo'
...
export default {
  ...
  methods: {
    ...
    showinfo(row) {
      location.href = "/DyDataInfoloopinfo.html?companyName=" + encodeURI(row.companyName)
    },
    //查询
    search: function () {
