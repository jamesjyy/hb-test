  ...
  export default {
    ...
    methods: {
      ...
      viewclick(row) {
        ...
        //跳转页面
        window.location.href = './DzDataManage.html?' + str;
      ...
      viewclickMag(row) {
        ...
        //跳转页面
        window.location.href = './DzDataChild.html?' + str;
      },
      initData () {
        //查询后台返回数据进行幅值
