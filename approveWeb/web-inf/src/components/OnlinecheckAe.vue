<template>
  <div class="companylist">
    ...
    <div class="tableth">
      <el-table :data="tableData" border style="width: 98%" :cell-style="rowStyle">
        ...
        <el-table-column sortable prop="sensorid" label="传感器ID" width="98" align="center"></el-table-column>
        <el-table-column sortable prop="position" label="传感器位置" width="98" align="center"></el-table-column>
        <el-table-column sortable prop="battery" label="传感器电量" width="98" align="center"></el-table-column>
        <el-table-column sortable prop="temperature" label="传感器温度" width="98" align="center"></el-table-column>
        <el-table-column sortable prop="humidity" label="传感器湿度" width="98" align="center"></el-table-column>
        <el-table-column sortable prop="amplitudethd" label="幅值阈值" width="85" align="center"></el-table-column>
        <el-table-column sortable prop="amplitudemax" label="幅值上限" width="85" align="center"></el-table-column>
        <el-table-column sortable prop="amplitudemin" label="幅值下限" width="85" align="center"></el-table-column>
        <el-table-column sortable prop="amplitudegain" label="幅值增益" width="85" align="center"></el-table-column>
        <el-table-column sortable prop="amplitudemean" label="幅值均值" width="85" align="center"></el-table-column>
        <el-table-column sortable prop="amplitudepeak" label="幅值峰值" width="85" align="center"></el-table-column>

        <el-table-column sortable prop="statuscode" label="状态代码" width="85"
                         align="center">
        </el-table-column>
...
export default {
  data() {
    return {
      ...
      fuhao: ";",
      JSONBody: "",
      jsonformname: "select * from db_ae.",
  ...
  methods: {
    ...
    rowStyle({row, column, rowIndex, columnIndex}) {
      if (columnIndex == 13 && row.statuscode !== 0) { //指定坐标rowIndex ：行，columnIndex ：列
      ...
      initData(Qs.stringify(data)).then((res) => {
        ...
        if (arr == "" || arr == null) {
          ...
          let arr1 = arr.map(item => ({
            ...
            amplitudemax: item[7],
            amplitudemin: item[8],
            amplitudegain: item[9],
            amplitudemean: item[10],
