  ...
  <div class="DataAnalyse">
    <div class="tableth">
      ...
      <div class="FileList" ref="print" id="print">
        <div>
          <!--          杆塔图-->
          <!--          加上@click="window.location.href = './DzDataCollect.html?'" 跳转页面 -->
...
<script>
  ...
  import {drawDiagonal} from '@/network/dzDataAnalyse/cancas.js'

  Vue.use(Print)
  import {request} from '@/network/request.js';
  import {initData} from '@/network/dzDataAnalyse/dzDataAnalyse.js';
  ...
  export default {
    ...
    methods: {
      ...
      show2() {
        ...
        window.location.href = './DzDataInfo.html?';
      }, xiangbie(row) {
        this.userid == "";
        request({
          method: 'get',
          url: 'dzData/queryTower',
          params: {
            id: this.userid,
            companyname: this.companyName,
            role: this.role,
      ...
      wordclick() {
        ...
        let docxsrc = "../../static/dzfaultwordout.docx";
        let _this = this;
